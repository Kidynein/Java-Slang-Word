...
public class DefQuizController {
    ...
    private String correctAnswer; // Biến để lưu đáp án đúng (là 1 Slang)
    ...
    private void loadNewQuestion() {
        // Lấy câu đố (Definition Quiz) từ Model
        SlangDictionary.QuizQuestion quiz = dictionary.createDefinitionQuiz();

        // Lưu đáp án đúng
        this.correctAnswer = quiz.correctAnswer();

        // Cập nhật giao diện
        questionLabel.setText(quiz.question()); // Hiển thị Definition
        optionButton1.setText(quiz.options().get(0)); // Hiển thị 4 Slangs
